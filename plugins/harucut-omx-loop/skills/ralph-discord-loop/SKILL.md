...
description: 이 저장소를 Ralph 스타일 자율 루프로 운영한다. Discord 원격 제어, 엄격한 브랜치 안전장치, develop_loop 대상 issue 브랜치 흐름, 결제/자격증명/외부 계정/프로덕션 배포/비가역 작업에서만 사용자 승인을 포함한다.
---
