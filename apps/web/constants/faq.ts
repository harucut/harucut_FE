...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    // 서버가 요금제로 가르는 것은 커스텀 프레임 개수와 보관 기간 둘뿐이다.
    // 보정은 등급과 무관하게 모두 되고 광고는 아직 없다 — 적으면 사실이 아니다.
    a: "커스텀 프레임 개수와 사진 보관 기간이 달라요. 무료는 사진을 3일간 보관하고 커스텀 프레임은 저장할 수 없어요. 베이직은 커스텀 프레임 3개와 3개월 보관을 제공해요. 보정 필터는 두 플랜 모두 그대로 쓸 수 있어요.",
    surfaces: ["landing", "pricing"],
  },
  {
    q: "플랜은 언제든 바꿀 수 있나요?",
