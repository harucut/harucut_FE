...
export function EventBanner({ eventName }: { eventName: string }) {
  return (
    ...
    <p className="flex items-center gap-2 rounded-2xl border border-[color:var(--hc-border)] bg-[color:var(--hc-surface)] px-3.5 py-2.5 text-[12px] font-semibold leading-[1.5] text-[color:var(--hc-text)]">
      <QrCode aria-hidden className="h-4 w-4 shrink-0 text-[color:var(--hc-muted)]" />
