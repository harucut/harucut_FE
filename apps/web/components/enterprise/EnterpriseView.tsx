...
const FLOW = [
  ...
  },
  {
    who: "주최자",
    title: "QR 한 장을 받아요",
    body: "그 프레임으로 바로 촬영이 시작되는 주소를 QR로 만들어 드립니다. 인쇄해서 부스에 세워 두기만 하면 돼요.",
  },
  {
    who: "참가자",
    title: "QR을 찍고 바로 촬영해요",
    body: "앱을 받을 필요도, 가입할 필요도 없어요. 휴대폰 카메라로 QR을 찍으면 그 행사 프레임이 이미 골라진 채로 촬영 화면이 열려요.",
  },
  {
    who: "참가자",
      ...
      <main className="mx-auto flex w-full max-w-[1160px] flex-col gap-20 px-5 pb-24 pt-10 sm:px-8 lg:gap-28 lg:pt-16">
        ...
        <Reveal as="section" className="flex flex-col gap-6">
          ...
          <p className="max-w-[52ch] text-[16px] leading-[1.75] text-[color:var(--hc-muted)] lg:text-[18px]">
            행사 전용 프레임을 만들어 드리고, 그 프레임으로 바로 촬영이 시작되는 QR을
            드려요. 참가자는 앱을 받지도, 가입하지도 않고 자기 휴대폰으로 찍어 그 자리에서
            가져갑니다.
          </p>
